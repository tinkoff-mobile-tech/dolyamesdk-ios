...
- (void)createWithSendGeo:(BOOL)sendGeo sendMac:(BOOL)sendMac sendDeviceHash:(BOOL)sendDeviceHash resourcesBundle: (NSBundle *)resourcesBundle apiKey: (NSString *)apiKey regionalDomain: (NSString *) regionalDomain sendHostName:(BOOL)isSendHostname sendActiveCall:(BOOL) isSendActiveCall;
...
/// Stop scoring and flush all data
- (void)stop;
...
/// Don't use this method in app.
/// @param token Token for JuicyApp
- (void) setOfflineToken:(NSString *) token;
