...
<sub><sup>Важно: Данная документация не отражает те взаимодействия, которые происходят между приложением интегратора и их бэкендом, а также между бэкендом приложения интегратора и бэкендом сервиса Долями.</sub></sup>
